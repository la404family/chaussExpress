        ...
        public function handleRequest($method, $data)
        {
            switch ($method) {
                ...
                case 'GET':
                    ...
                    case 'POST':
                         if (!empty($data['modele']) && !empty($data['description']) && !empty($data['prix']) && !empty($data['image']) && !empty($data['marque_id'])) {
                      ...
                      $modelePresente = $this->modeles->getByName(['modele' => $modele]);
        if ($modelePresente) {
